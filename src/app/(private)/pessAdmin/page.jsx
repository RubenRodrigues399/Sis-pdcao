      ...
      <main className="flex-1 bg-gray-100 p-8">
        ...
        <div className="flex justify-between items-center">
         ...
         <table className="w-full mt-4 border-collapse">
             ...
             <h2 className="text-lg font-semibold mb-4 text-center">Cadastro de Pessoal Administrativo</h2>
             <form className="grid grid-cols-2 gap-4 mt-5">
                       <input type="text" className="border placeholder-black p-2 rounded col-span-2" placeholder="Nome" />
                       ...
                       <input type="email" className="border placeholder-black rounded p-2" placeholder="Email" />
                       <input type="text" className="border placeholder-black rounded p-2" placeholder="Telefone" />
                       <input type="date" className="border rounded p-2" />
                       <input type="text" className="border placeholder-black p-2 rounded" placeholder="Enderço" />
                       <input type="password" className="border placeholder-black rounded p-2" placeholder="Senha" />
                       <input type="password" className="border placeholder-black rounded p-2" placeholder="Confirmar senha" />
         
             </form>
                   <div className="flex space-x-4 justify-center mt-6">
                     <button className="bg-green-500 text-white px-6 py-2 rounded">Registrar</button>
                   </div>
                   </Modal>
          <Footer />
    </>
